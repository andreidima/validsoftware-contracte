...
class GeneratorController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function genereaza(Client $client = null, $tip_fisier = null)
    {

        switch ($tip_fisier) {
            case 'protectia-datelor-cu-caracter-personal':
                return view('generator.fisiere.protectia-datelor-cu-caracter-personal', compact('client'));
                break;
