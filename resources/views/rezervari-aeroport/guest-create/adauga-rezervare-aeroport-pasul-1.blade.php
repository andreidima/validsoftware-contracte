        ...
        <div class="col-md-9">
            <div class="shadow-lg bg-white" style="border-radius: 40px 40px 40px 40px;">
                <div class="border border-danger p-2 d-flex justify-content-between align-items-end" style="border-radius: 40px 40px 0px 0px;">                     
                    <h3 class="ml-3" style="color:brown"><i class="fas fa-ticket-alt fa-lg mr-1"></i>Rezervare bilet aeroport</h3>
                ...
                <div class="card-body py-2" 
                    ...
                    "
                    id="adauga-rezervare-aeroport"
                >
                    <form  class="needs-validation" novalidate method="POST" action="/adauga-rezervare-aeroport-pasul-1">
                        @csrf
                        ...
                        <div class="form-row mb-0 d-flex justify-content-center border-radius: 0px 0px 40px 40px">
                            <div class="form-group col-lg-12 px-2 mb-0">
                                ...
                                <div class="form-row mb-4 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="custom-control custom-switch col-lg-3 text-center mx-auto">
                                        <script type="application/javascript"> 
                                ...
                                <div class="form-row mb-3 px-2 pt-2 d-flex justify-content-between align-items-center bg-primary border rounded">                                    
                                    ...
                                    <div class="form-group col-lg-6 m-0 d-flex">
                                        ...
                                        <div class="col-lg-4 px-0 d-flex align-self-center">  
                                            <button type="button" class="btn m-0 p-0"
                                                v-on:click="nr_adulti -= 1;getPreturi();getPretTotal()"
                                                >
                                    ...
                                    <div class="form-group col-lg-6 m-0 d-flex">
                                        ...
                                        <div class="col-lg-4 px-0 d-flex align-self-center">  
                                            <button type="button" class="btn m-0 p-0"
                                                v-on:click="nr_copii -= 1;getPreturi();getPretTotal()"
                                                >
                                                <i class="far fa-minus-square bg-danger text-white fa-2x"></i>
                                            </button>   
                                            <script type="application/javascript"> 
