    ...
    <div class="form-group col-lg-12 px-2 mb-0">
        ...
        <div class="form-row px-2 py-2 mb-0">
            ...
            <div class="form-group col-lg-2 mb-0">
                ...
                <select name="sex" class="custom-select-sm custom-select rounded-pill {{ $errors->has('sex') ? 'is-invalid' : '' }}">
                    <option></option>
                    <option value='1' {{ intval(old('sex', $clienti->sex)) === 1 ? 'selected' : '' }}>Masculin</option>
                    <option value='2' {{ intval(old('sex', $clienti->sex)) === 2 ? 'selected' : '' }}>Feminin</option>
                </select>
            </div>
        </div>
        <div class="form-row px-2 py-2 mb-0">
        ...
        <div class="form-row px-2 py-2">
            <div class="form-group col-lg-12 mb-2">
                <label for="servicii_efectuate" class="mb-0 pl-1">Servicii pentru care a fost lăsat un review:</label>
                    <div class="form-row">
