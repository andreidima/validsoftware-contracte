    ...
    <div class="form-group col-lg-12 px-2 mb-0">
        <div class="form-row px-2 py-2 mb-2 justify-content-left">
            <div class="form-group col-lg-12 mb-2">
                <label for="nume" class="mb-0 pl-3">Categoria:</label>
                <input
                    type="text"
                    class="form-control form-control-sm rounded-pill {{ $errors->has('nume') ? 'is-invalid' : '' }}"
                    name="nume"
                    placeholder=""
                    value="{{ old('nume') ?? $categorie->nume }}"
                    required>
            </div>
        </div>
        ...
        <div class="form-row mb-3 px-2 justify-content-center">
            <div class="col-lg-8 d-flex justify-content-center">
                ...
                <a class="btn btn-secondary btn-sm mr-4 rounded-pill" href="/service/componente-pc/categorii">Renunță</a>
            </div>
        </div>
    </div>
</div>
