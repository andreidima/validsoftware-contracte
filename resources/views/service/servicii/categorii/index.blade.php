...
<div class="container card" style="border-radius: 40px 40px 40px 40px;">
        <div class="row card-header align-items-center" style="border-radius: 40px 40px 0px 0px;">
            <div class="col-lg-3">
                <h4 class=" mb-0"><a href="{{ route('service.servicii.categorii.index') }}"><i class="fas fa-file-alt mr-1"></i>Categorii servicii</a></h4>
            </div>
            <div class="col-lg-6">
                <form class="needs-validation" novalidate method="GET" action="{{ route('service.servicii.categorii.index') }}">
                    @csrf
                    <div class="row input-group custom-search-form">
                        ...
                        <a class="btn btn-sm bg-secondary text-white col-md-4 border border-dark rounded-pill" href="{{ route('service.servicii.categorii.index') }}" role="button">
            ...
            <div class="col-lg-3 text-right">
                <a class="btn btn-sm bg-success text-white border border-dark rounded-pill col-md-8" href="{{ route('service.servicii.categorii.create') }}" role="button">
                                            ...
                                            <div class="modal fade text-dark" id="stergeCategorie{{ $categorie->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-body" style="text-align:left;">
                                                        Ești sigur ca vrei să ștergi Categorie?
                                                    </div>
