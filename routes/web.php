...
// ChatGPT Open AI
Route::middleware('role:chatgpt')->group(function () {
...
Route::middleware('role:admin')->group(function () {
    ...
    Route::get('/testare-download-image', function() {
        $url = 'https://supermarketitalian-d7c1.kxcdn.com/wp-content/uploads/2023/05/Acid-muriatic-pur-Amacasa-32-1-L-8004393710005-1.jpg';

        // $url = 'http://example.com/image.php';
        $img = public_path(substr($url, strrpos($url, '/') + 1));
        file_put_contents($img, file_get_contents($url));

        // $ch = curl_init('$url');
        // $fp = fopen(public_path(substr($url, strrpos($url, '/') + 1)), 'wb');
